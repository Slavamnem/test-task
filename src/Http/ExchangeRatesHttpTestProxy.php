...
class ExchangeRatesHttpTestProxy implements ExchangeRatesHttpInterface
{
    ...
    private const EUR_TO_UDS_EXCHANGE_RATE = 1.1497;
    ...
    {
        return new ExchangeRatesResponseDTO(CurrencyEnum::Eur->value, (new DateTime('now'))->format('Y-m-d'), [
            CurrencyEnum::Eur->value => self::EUR_TO_EUR_EXCHANGE_RATE,
            CurrencyEnum::Usd->value => self::EUR_TO_UDS_EXCHANGE_RATE,
